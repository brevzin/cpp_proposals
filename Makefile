...
$(eval $(call add_better_paper,1185-7_spaceship,p1185r1.html,spaceship-no-eq.md))
$(eval $(call add_better_paper,1185-7_spaceship,d1186r1.html,spaceship-is-compare.md))
$(eval $(call add_better_paper,1185-7_spaceship,d1187r1.html,compare-trait.md))
