...
- [5.14]{.pnum} [...]
- [5.26]{.pnum} a `dynamic_cast` ([expr.dynamic.cast]) or `typeid` ([expr.typeid]) expression [on a glvalue that refers to an object whose dynamic type is constexpr-unknown or]{.addu} that would throw an exception;
:::
