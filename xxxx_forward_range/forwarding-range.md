...
This is a perfectly reasonable C++11 range, yet `my_vector<T>` satisfies _`forwarding-range`_ because the rvalue invocation would happily match the `const&` overload.
