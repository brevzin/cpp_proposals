...
* [#.#]{.pnum} If `is_lvalue_reference_v<common_reference_t<iter_reference_t<$InnerIter$>, iter_reference_t<$PatternIter$>>>` is `false`, `iterator_category` denotes `input_iterator_tag`.
