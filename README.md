...
- [p1186r1 - When do you actually use `<=>`?](1185-7_spaceship/p1186r1.html). Approved in San Diego, needs to come back to EWG with design changes after Core review.
- [p1187r1 - A type trait for `std::compare_3way()`'s type](1185-7_spaceship/p1187r1.html). Approved in San Diego.
